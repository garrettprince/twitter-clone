            ...
            <div className='flex space-x-3'>
                ...
                <div>
                    <div className='flex items-center space-x-1'>
                        ...
                        <p className='hidden text-sm text-gray-500 sm:inline-flex'>@{tweet.username.replace(/\s+/g, '').toLowerCase()} •</p>
            ...
            {commentBoxVisible && (
                ...
                >
                    <input 
                        ...
                        className='flex-1 rounded-lg bg-gray-100 p-2 outline-none' type="text" 
